...
exports.cpfMiddleware = exports.passwordMiddleware = void 0;
...
const passwordMiddleware = (req, res, next) => {
    ...
    if (!validatePassword(password)) {
        return res.status(400).json({
            message: 'Invalid password. The password must contain at least 8 characters, 1 lowercase letter, 1 uppercase letter and 1 number.',
        });
    }
    return next();
};
